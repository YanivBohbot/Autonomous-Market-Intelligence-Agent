...
from app.agent.multi_agent.crm_agent import build_crm_agent
...
# finance_agent/crm_agent (which build their prompt from state["messages"])
...
workflow.add_node("crm_agent", build_crm_agent())
